...
static const _MotorVels_type_support_symbol_names_t _MotorVels_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, serial_motor_msgs, msg, MotorVels)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, serial_motor_msgs, msg, MotorVels)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, serial_motor_msgs, msg, MotorVels)() {
  return &::serial_motor_msgs::msg::rosidl_typesupport_c::MotorVels_message_type_support_handle;
}
