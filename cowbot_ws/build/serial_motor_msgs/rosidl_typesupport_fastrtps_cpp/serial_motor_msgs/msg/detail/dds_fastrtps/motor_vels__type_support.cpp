...
#include "serial_motor_msgs/msg/detail/motor_vels__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const serial_motor_msgs::msg::MotorVels & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  serial_motor_msgs::msg::MotorVels & ros_message)
{
  // Member: mot_1_rad_sec
  cdr >> ros_message.mot_1_rad_sec;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = serial_motor_msgs::msg::MotorVels;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_serial_motor_msgs
max_serialized_size_key_MotorVels(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const serial_motor_msgs::msg::MotorVels *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<serial_motor_msgs::msg::MotorVels *>(
    untyped_ros_message);
...
{
  return &serial_motor_msgs::msg::typesupport_fastrtps_cpp::_MotorVels__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, serial_motor_msgs, msg, MotorVels)() {
  return &serial_motor_msgs::msg::typesupport_fastrtps_cpp::_MotorVels__handle;
}
