...
#include "serial_motor_msgs/msg/detail/encoder_vals__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const serial_motor_msgs::msg::EncoderVals & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  serial_motor_msgs::msg::EncoderVals & ros_message)
{
  // Member: mot_1_enc_val
  cdr >> ros_message.mot_1_enc_val;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = serial_motor_msgs::msg::EncoderVals;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_serial_motor_msgs
max_serialized_size_key_EncoderVals(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const serial_motor_msgs::msg::EncoderVals *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<serial_motor_msgs::msg::EncoderVals *>(
    untyped_ros_message);
...
{
  return &serial_motor_msgs::msg::typesupport_fastrtps_cpp::_EncoderVals__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, serial_motor_msgs, msg, EncoderVals)() {
  return &serial_motor_msgs::msg::typesupport_fastrtps_cpp::_EncoderVals__handle;
}
