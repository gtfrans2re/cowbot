...
{
  new (message_memory) serial_motor_msgs::msg::MotorVels(_init);
}

void MotorVels_fini_function(void * message_memory)
{
  auto typed_message = static_cast<serial_motor_msgs::msg::MotorVels *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember MotorVels_message_member_array[2] = {
  {
    ...
    offsetof(serial_motor_msgs::msg::MotorVels, mot_1_rad_sec),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(serial_motor_msgs::msg::MotorVels, mot_2_rad_sec),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers MotorVels_message_members = {
  ...
  2,  // number of fields
  sizeof(serial_motor_msgs::msg::MotorVels),
...
get_message_type_support_handle<serial_motor_msgs::msg::MotorVels>()
{
  return &::serial_motor_msgs::msg::rosidl_typesupport_introspection_cpp::MotorVels_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, serial_motor_msgs, msg, MotorVels)() {
  return &::serial_motor_msgs::msg::rosidl_typesupport_introspection_cpp::MotorVels_message_type_support_handle;
}
