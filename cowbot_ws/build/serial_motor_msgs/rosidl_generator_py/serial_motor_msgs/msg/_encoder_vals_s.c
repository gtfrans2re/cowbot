...
bool serial_motor_msgs__msg__encoder_vals__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("serial_motor_msgs.msg._encoder_vals.EncoderVals", full_classname_dest, 47) == 0);
  }
  serial_motor_msgs__msg__EncoderVals * ros_message = _ros_message;
  {  // mot_1_enc_val
...
PyObject * serial_motor_msgs__msg__encoder_vals__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("serial_motor_msgs.msg._encoder_vals");
