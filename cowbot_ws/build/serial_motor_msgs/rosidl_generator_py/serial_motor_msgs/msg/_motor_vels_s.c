...
bool serial_motor_msgs__msg__motor_vels__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("serial_motor_msgs.msg._motor_vels.MotorVels", full_classname_dest, 43) == 0);
  }
  serial_motor_msgs__msg__MotorVels * ros_message = _ros_message;
  {  // mot_1_rad_sec
...
PyObject * serial_motor_msgs__msg__motor_vels__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("serial_motor_msgs.msg._motor_vels");
