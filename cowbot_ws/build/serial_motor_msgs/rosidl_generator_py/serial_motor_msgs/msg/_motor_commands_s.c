...
bool serial_motor_msgs__msg__motor_commands__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("serial_motor_msgs.msg._motor_commands.MotorCommands", full_classname_dest, 51) == 0);
  }
  serial_motor_msgs__msg__MotorCommands * ros_message = _ros_message;
  {  // is_pwm
...
PyObject * serial_motor_msgs__msg__motor_commands__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("serial_motor_msgs.msg._motor_commands");
