...
bool cdr_serialize_lslidar_msgs__msg__LslidarSweep(
  const lslidar_msgs__msg__LslidarSweep * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
  ...
  // Field name: scans
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_lslidar_msgs__msg__LslidarScan(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_lslidar_msgs
bool cdr_deserialize_lslidar_msgs__msg__LslidarSweep(
  eprosima::fastcdr::Cdr & cdr,
  lslidar_msgs__msg__LslidarSweep * ros_message)
{
  // Field name: header
  {
  ...
  // Field name: scans
  {
    ...
    auto array_ptr = ros_message->scans;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_lslidar_msgs__msg__LslidarScan(cdr, &array_ptr[i]);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_lslidar_msgs
bool cdr_serialize_key_lslidar_msgs__msg__LslidarSweep(
  const lslidar_msgs__msg__LslidarSweep * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  ...
  // Field name: scans
  {
    ...
    auto array_ptr = ros_message->scans;
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_lslidar_msgs__msg__LslidarScan(
        &array_ptr[i], cdr);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_lslidar_msgs
size_t get_serialized_size_key_lslidar_msgs__msg__LslidarSweep(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _LslidarSweep__ros_msg_type * ros_message = static_cast<const _LslidarSweep__ros_msg_type *>(untyped_ros_message);
  ...
  // Field name: scans
  {
    ...
    auto array_ptr = ros_message->scans;
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_lslidar_msgs__msg__LslidarScan(
        &array_ptr[index], current_alignment);
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_lslidar_msgs
size_t max_serialized_size_key_lslidar_msgs__msg__LslidarSweep(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Field name: scans
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_lslidar_msgs__msg__LslidarScan(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const lslidar_msgs__msg__LslidarSweep * ros_message = static_cast<const lslidar_msgs__msg__LslidarSweep *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_lslidar_msgs__msg__LslidarSweep(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  lslidar_msgs__msg__LslidarSweep * ros_message = static_cast<lslidar_msgs__msg__LslidarSweep *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_lslidar_msgs__msg__LslidarSweep(cdr, ros_message);
}
