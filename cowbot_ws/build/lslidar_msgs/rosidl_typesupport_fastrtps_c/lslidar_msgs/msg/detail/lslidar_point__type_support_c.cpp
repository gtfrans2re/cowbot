  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const lslidar_msgs__msg__LslidarPoint * ros_message = static_cast<const lslidar_msgs__msg__LslidarPoint *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_lslidar_msgs__msg__LslidarPoint(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  lslidar_msgs__msg__LslidarPoint * ros_message = static_cast<lslidar_msgs__msg__LslidarPoint *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_lslidar_msgs__msg__LslidarPoint(cdr, ros_message);
}
