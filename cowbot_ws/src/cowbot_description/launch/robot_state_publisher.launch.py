...
def launch_setup(context, *args, **kwargs):
    ...
    package_description = "cowbot_description"
...
def generate_launch_description():
    robot_name_arg = DeclareLaunchArgument("robot_name", default_value="cowbot")
    robot_file_arg = DeclareLaunchArgument("robot_file", default_value="cowbot_multi_sim.xacro")
